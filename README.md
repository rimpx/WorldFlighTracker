...
### 3. Imposta le porte pubbliche
- Se stai utilizzando codespaces, imposta le porte pubbliche

### 4. Controlla che le porte stiano funzionando correttamente
- Apri gli indirizzi delle porte e controlla che funzionino correttamente

### 5. Utilizza l'applicazione
- Una volta completati i passaggi precedenti, puoi utilizzare l'applicazione!
